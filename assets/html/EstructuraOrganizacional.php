...
<body>
  ...
  <main>
    ...
    <section class="estructuraOrganizacional">
      <div class="contenedorOrganizacional">
        <h1>Integrantes</h1>
        <h3>Juan Esteban Osorio Lopera</h3>
        <p>Estudiante en curso de Ing. Sistemas, cuenta con 3 años en la area de desarrollo, con acreditacion de Desarrollador Web Full Stack.</p>
        <h2>Hanilidades</h2>
        <p>HTML, CSS, SASS, PHP, Javascript, Java, Python</p>
      </div>
    </section>
  </main>
