      ...
      case 'Buscar':
        ...
        //  echo print_r($ArrarFinal) ;//muestra requerimiento con su ultimo estado y todos las observaciones
          ...
          if ( count($Arrayfiltrado)!==0) {
                  ...
                  <table>
                      <tr>
                        <td colspan="2">Requerimientos Sin Asignar</td>
                      </tr>
                      <tr>
                        <td><select  id="SelectReque">'.$optionRequerimiento.'</select></td>
                        <td> <button type="button" id="Seleccionar" >Seleccionar</button></td>
                      </tr>
                    <table>'; 
              }else{
                  echo $SiguienteSelect='<span>No hay Requerimientos Para Asignar</span>'; 
              }   
        ...
        if ($respuestaEmpleado->num_rows!==0) {
            ...
            for ($b=0; $b < $respuestaEmpleado->num_rows; $b++) { 
              ...
              <table class="tabla--observaciones">
                <tr>
                    <td colspan="2"> Observaciones Anteriores</td>
                </tr>

                <tr>
                    <td colspan="2"><textarea name="observaciones" id="observaciones" rows="5" cols="50" disabled >'. $TodasObservaciones.'</textarea></td>
                ...
                <tr>
                  <form action="/action_page.php">
                    <td> 
                      ...
                      <input type="radio" id="cancelar" name="option" value="Cancelar">
                    </td>
                    <td>
                      <label for="asignar">Asignar</label>
                      <input type="radio" id="asignar" name="option" value="Asignar" checked>
                    </td>
                  </form>
                </tr>
                ...
                <tr>
                  <td colspan="2">
                    <label for="" id="nombreempl">Radicado por: 
                    </label>
                    <label for="" id="empleadoradico">'.$respuestaEmpleadoNombrecreo.'
                    </label>
                  </td>
                </tr>
                <tr>  
                  <td colspan="2">Asignar a: '.$selectEmpleado.'</td>
                </tr>
                <tr>
